...
import { Loader2, X, BookPlus, Image as ImageIcon, Coins, Sparkles, AlertCircle, Code2, Layers } from "lucide-react";
                ...
                <div className="px-5 py-4 border-b border-ink-200 bg-gradient-to-br from-primary-50/60 to-accent-50/60">
                    <div className="flex items-start justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 id="add-course-title" className="text-lg font-bold text-ink-900">Thêm khóa học mới</h2>
